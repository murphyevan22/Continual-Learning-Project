...
class SparsePruner(object):
    ...
    def __init__(self, model, prune_perc, previous_masks, train_bias, train_bn):
        ...
        print(f"Current DS IDX = {self.current_dataset_idx}")
    ...
    def pruning_mask(self, weights, previous_mask, layer_idx):
        ...
        # print(f"Cutoff_rank={cutoff_rank}")
        ...
        # print(f"Cutoff_value={cutoff_value}")
    ...
    def prune(self):
        ...
        print(f'Pruning for dataset idx: {self.current_dataset_idx} ({type(self.current_dataset_idx)})')
        print("Using PackNet pruning function")
    ...
    def scale_grads(self):
        """Scale gradients of important weights."""
        assert self.current_masks
        # Need to set global learning rate as 1 here for constant and then use scaling factor
        # To act as LR to change important weights slightly
